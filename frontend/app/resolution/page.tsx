...
export default function ResolutionPage() {
  ...
  return (
    <div>
      ...
      {report && <div className="space-y-5"><p className="eyebrow text-success">MEASURED · Committed evaluation artifact</p><ResolutionChart report={report} /><DegeneracyWarning report={report} /><ResolutionTable report={report} /><p className="font-mono text-[10px] leading-relaxed text-slate-600">MODEL {report.model} · RUN {report.timestamp}</p></div>}
    </div>
  );
}
