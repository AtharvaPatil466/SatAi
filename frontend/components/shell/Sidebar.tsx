...
export function Sidebar() {
  ...
  return (
    <aside className="border-b border-border bg-[#08131d]/95 lg:sticky lg:top-0 lg:h-screen lg:border-b-0 lg:border-r">
      <Link href="/" aria-label="SatQuery AI home" className="flex h-14 cursor-pointer items-center gap-3 px-4 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent lg:h-[72px] lg:px-5">
